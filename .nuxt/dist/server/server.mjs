import { getCurrentInstance, reactive, effectScope, ref, markRaw, toRaw, inject, watch, unref, isRef, isReactive, toRef, nextTick, computed, getCurrentScope, onScopeDispose, toRefs, version, defineAsyncComponent, shallowRef, isReadonly, h, defineComponent, Transition, Suspense, provide, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, useSSRContext, withCtx, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch } from "ofetch";
import { useRuntimeConfig as useRuntimeConfig$1 } from "#internal/nitro";
import { createHooks } from "hookable";
import { getContext, executeAsync } from "unctx";
/* empty css                           */import { setupDevtoolsPlugin } from "@vue/devtools-api";
import "destr";
import "devalue";
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrInterpolate, ssrRenderSuspense } from "vue/server-renderer";
        ...
        Object.values(piniaStores).forEach((store) => {
          ...
          if (store._getters && store._getters.length) {
            payload.instanceData.state.push({
              ...
              key: "getters",
              editable: false,
              value: store._getters.reduce((getters2, key) => {
                try {
                  getters2[key] = store[key];
                } catch (error) {
                  getters2[key] = error;
                }
                return getters2;
...
const LazyIconCSS = defineAsyncComponent(() => import("./_nuxt/IconCSS-acf1adef.js").then((r) => r.default));
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/ContactsPage-31f8f614.js").then((m) => m.default || m)
  },
  {
    name: "MotorsPage",
    path: "/MotorsPage",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/MotorsPage-9d7a541c.js").then((m) => m.default || m)
  },
  {
    name: "ProductsPage",
    path: "/ProductsPage",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/ProductsPage-eb939c58.js").then((m) => m.default || m)
  },
  {
    name: "PropellersPage",
    path: "/PropellersPage",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/PropellersPage-429275cf.js").then((m) => m.default || m)
  },
  {
    name: "StartersPage",
    path: "/StartersPage",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/StartersPage-cb7d398f.js").then((m) => m.default || m)
  },
  {
    name: "SuccessPage",
    path: "/SuccessPage",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/SuccessPage-1efd6640.js").then((m) => m.default || m)
  },
  {
    name: "cart",
    path: "/cart",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/cart-bb610d04.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-6099cab9.js").then((m) => m.default || m)
  },
  {
    name: "products-slug",
    path: "/products/:slug()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_slug_-989c1243.js").then((m) => m.default || m)
  },
  {
    name: "success",
    path: "/success",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/success-853f0d23.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-3cec548e.js").then((m) => m.default || m),
  "products-layout": () => import("./_nuxt/products-layout-24c3e5ed.js").then((m) => m.default || m)
};
...
const ScrollToTopComponent_vue_vue_type_style_index_0_lang = "";
const _sfc_main$2 = {
  name: "back-top",
  data() {
    return {
...
const actions = {
  async fill() {
    this.products = (await import("./_nuxt/products-70797b01.js")).default;
  }
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-b1ec816e.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-df12c5a9.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
