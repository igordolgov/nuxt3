...
import { mergeProps, withCtx, unref, createTextVNode, createVNode, toDisplayString, useSSRContext, openBlock, createBlock } from "vue";
...
const AsideComponent_vue_vue_type_style_index_0_scoped_d8333c7d_lang = "";
const _sfc_main$1 = {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Моторы<div class="hidden sm_inline-block" data-v-d8333c7d${_scopeId}> (${ssrInterpolate(unref(products).filter((item) => item.category == "Моторы").length)})</div>`);
          } else {
            return [
              createTextVNode("Моторы"),
              createVNode("div", { class: "hidden sm_inline-block" }, " (" + toDisplayString(unref(products).filter((item) => item.category == "Моторы").length) + ")", 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Пропеллеры<div class="hidden sm_inline-block" data-v-d8333c7d${_scopeId}> (${ssrInterpolate(unref(products).filter((item) => item.category == "Пропеллеры").length)})</div>`);
          } else {
            return [
              createTextVNode("Пропеллеры"),
              createVNode("div", { class: "hidden sm_inline-block" }, " (" + toDisplayString(unref(products).filter((item) => item.category == "Пропеллеры").length) + ")", 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Стартеры<div class="hidden sm_inline-block" data-v-d8333c7d${_scopeId}> (${ssrInterpolate(unref(products).filter((item) => item.category == "Стартеры").length)})</div>`);
          } else {
            return [
              createTextVNode("Стартеры"),
              createVNode("div", { class: "hidden sm_inline-block" }, " (" + toDisplayString(unref(products).filter((item) => item.category == "Стартеры").length) + ")", 1)
            ];
          }
        }),
        _: 1
...
const engine101 = "" + __buildAssetsURL("engine1-01.48a26889.jpg");
const __vite_glob_0_0 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine101
});
const engine102 = "" + __buildAssetsURL("engine1-02.bab91204.jpg");
const __vite_glob_0_1 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine102
});
const engine103 = "" + __buildAssetsURL("engine1-03.0a24a999.jpg");
const __vite_glob_0_2 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine103
});
const engine104 = "" + __buildAssetsURL("engine1-04.03e68e50.jpg");
const __vite_glob_0_3 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine104
});
const engine105 = "" + __buildAssetsURL("engine1-05.e0234926.jpg");
const __vite_glob_0_4 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine105
});
const engine106 = "" + __buildAssetsURL("engine1-06.7ad6cb6d.jpg");
const __vite_glob_0_5 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine106
});
const engine107 = "" + __buildAssetsURL("engine1-07.11b2fb45.jpg");
const __vite_glob_0_6 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine107
});
const engine201 = "" + __buildAssetsURL("engine2-01.6ec63972.jpg");
const __vite_glob_0_7 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine201
});
const engine202 = "" + __buildAssetsURL("engine2-02.90ae422b.jpg");
const __vite_glob_0_8 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine202
});
const engine203 = "" + __buildAssetsURL("engine2-03.073aec9d.jpg");
const __vite_glob_0_9 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine203
});
const engine204 = "" + __buildAssetsURL("engine2-04.447ea78f.jpg");
const __vite_glob_0_10 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine204
});
const engine205 = "" + __buildAssetsURL("engine2-05.2dcc390e.jpg");
const __vite_glob_0_11 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine205
});
const engine206 = "" + __buildAssetsURL("engine2-06.ee37dd85.jpg");
const __vite_glob_0_12 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine206
});
const engine301 = "" + __buildAssetsURL("engine3-01.d21b1a5e.jpg");
const __vite_glob_0_13 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine301
});
const engine302 = "" + __buildAssetsURL("engine3-02.ac954bd9.jpg");
const __vite_glob_0_14 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine302
});
const engine303 = "" + __buildAssetsURL("engine3-03.78c7872c.jpg");
const __vite_glob_0_15 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine303
});
const engine304 = "" + __buildAssetsURL("engine3-04.d546d44e.jpg");
const __vite_glob_0_16 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine304
});
const engine305 = "" + __buildAssetsURL("engine3-05.71d57f81.jpg");
const __vite_glob_0_17 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine305
});
const engine306 = "" + __buildAssetsURL("engine3-06.2f624dc0.jpg");
const __vite_glob_0_18 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine306
});
const engine307 = "" + __buildAssetsURL("engine3-07.20ad9bf9.jpg");
const __vite_glob_0_19 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine307
});
const engine308 = "" + __buildAssetsURL("engine3-08.7cd5d70d.jpg");
const __vite_glob_0_20 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine308
});
const engine309 = "" + __buildAssetsURL("engine3-09.972b6eec.jpg");
const __vite_glob_0_21 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine309
});
const engine310 = "" + __buildAssetsURL("engine3-10.564438e1.jpg");
const __vite_glob_0_22 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: engine310
});
const propeller101 = "" + __buildAssetsURL("propeller1-01.62f2a13b.jpg");
const __vite_glob_0_23 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: propeller101
});
const propeller201 = "" + __buildAssetsURL("propeller2-01.c8359f11.jpg");
const __vite_glob_0_24 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: propeller201
});
const propeller301 = "" + __buildAssetsURL("propeller3-01.9eb59fda.jpg");
const __vite_glob_0_25 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: propeller301
});
const propeller401 = "" + __buildAssetsURL("propeller4-01.d0dc41ef.jpg");
const __vite_glob_0_26 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: propeller401
});
const propeller501 = "" + __buildAssetsURL("propeller5-01.4822a8eb.jpg");
const __vite_glob_0_27 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: propeller501
});
const shoes = "" + __buildAssetsURL("shoes.9da58c3d.jpg");
const __vite_glob_0_28 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: shoes
});
const starter101 = "" + __buildAssetsURL("starter1-01.31266f0d.jpg");
const __vite_glob_0_29 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: starter101
});
const starter201 = "" + __buildAssetsURL("starter2-01.c77d50b4.jpg");
const __vite_glob_0_30 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: starter201
});
const starter301 = "" + __buildAssetsURL("starter3-01.08aa1c15.jpg");
const __vite_glob_0_31 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: starter301
});
const starter401 = "" + __buildAssetsURL("starter4-01.4574346f.jpg");
const __vite_glob_0_32 = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  default: starter401
});
const sunglasses = "" + __buildAssetsURL("sunglasses.b275f230.jpg");
...
//# sourceMappingURL=PreviewComponent-9c74d793.js.map
