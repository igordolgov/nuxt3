...
const _sfc_main = {
  __name: "PropellersPage",
  __ssrInlineRender: true,
  setup(__props) {
    const productStore = useProductStore();
    const products = productStore.products.filter((item) => item.category == "\u041F\u0440\u043E\u043F\u0435\u043B\u043B\u0435\u0440\u044B");
    productStore.fill();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_AsideComponent = __nuxt_component_0;
      const _component_PreviewComponent = __nuxt_component_1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "propellers-page" }, _attrs))}><head><title>SKSAVIA - \u041F\u0440\u043E\u043F\u0435\u043B\u043B\u0435\u0440\u044B</title></head><div class="h-full flex-row sm_flex p-4 pb-0">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/PropellersPage.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=PropellersPage-429275cf.mjs.map
